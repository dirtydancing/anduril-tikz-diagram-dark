...
\colorlet{advancedconfigmenu-draw}{advancedconfig-draw}
\colorlet{advancedconfigmenu-fill}{advancedconfig-fill}
\colorlet{advancedconfigmenu-text}{advancedconfigmenu-draw}
...
\colorlet{factoryresetsimpleUI-draw}{advancedUIswitchline-draw}
...
\tcbset{
    ...
    colback=anyconfig-fill, % initially black!5!white
...
\node (Types of brightness memory information)[
    advancedconfig,
    above=0.2cm of Manual Memory from ON.north west,
    anchor=south west
]
{
    Types of brightness\\
...
{ [on background layer]
    \node (Misc Config from OFF)[
        advancedconfigmenu,
        right=0.9cm of Simple UI Config from OFF.north east,
        anchor=north west
    ]
    {
        \spacingnoextra
...
]
{
    ...
    \normalsize Diagram Release Dark-05\\[4pt]
    Diagram Repository:\\
