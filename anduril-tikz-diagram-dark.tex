...
\SetTblrInner[tblr-buttonpresses]{
    ...
    colsep     = 0pt,
    column{3}  = {leftsep=2.5pt}, % for horizontal space to colon
...
node[
    anybutton,
    pos=0.44,
    label={ [align=left, xshift=0.515cm+1.3pt] right:
...
]
{
    ...
    \normalsize Diagram Release Dark-07\\[4pt]
    Diagram Repository:\\
...
\path (Legend-1-1.west) edge[
    ...
    shorten <=0.15pt, % out (0.3pt overhang)
    shorten >=0.15pt, % in (0.3pt overhang)
    out=0,
    in=180
]
node[
