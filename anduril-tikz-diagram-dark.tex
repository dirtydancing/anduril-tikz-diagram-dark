...
\definecolor{purple-2}{HTML}{6F2FBE}
\definecolor{black-2}{HTML}{121212}
...
\colorlet{anyconfigmode-draw}{purple-2}
...
\colorlet{generalinfo-draw}{anyconfigmode-draw}
\colorlet{generalinfo-fill}{anybutton-fill}
\colorlet{andurilinfo-draw}{onoff-draw}
...
\newcommand{\infotextany}[1]{\textcolor{any-text}{#1}}

% for infotext for Advanced UI only
\newcommand{\infotextadvanced}[1]{\textcolor{advanced-text}{#1}}

% for infotext for Simple UI only
\newcommand{\infotextsimple}[1]{\textcolor{simple-text}{#1}}
...
at (current page.center)[
    rampsmooth,
    anchor=east,
    top color=rampsmooth-topbottom!40,
...
\node (Ramp Stepped 1-2)[
    ...
    anchor=south west,
    top color=rampstepped-topbottom,
...
\node (Ramp Stepped 2-3)[
    ...
    bottom color=rampstepped-topbottom!80
]
{};
...
\node (Ramp Stepped 3-4)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!80,
    bottom color=rampstepped-topbottom!70
]
{};
...
\node (Ramp Stepped 4-5)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!70,
...
+(-1.7cm, -2.25cm) edge[
    ...
    postaction={
        decoration={
            text along path,
            text={|\footnotesize\color{advanced-text}|Mode memory},
            reverse path,
...
]
{
    ...
    \normalsize Diagram Release Dark-01\\[4pt]
    Diagram Repository:\\
