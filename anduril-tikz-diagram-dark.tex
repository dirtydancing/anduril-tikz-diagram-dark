...
% Copyright (C) 2025 Guido dirtydancing
...
\colorlet{anybutton-fill}{black-2}
\colorlet{anyconfig-fill}{anybutton-fill}
...
\colorlet{anyconfigmode-draw}{yellow-2}

% advanced... mode = for strobe modes and blinky modes
\colorlet{advancedconfigmode-draw}{anyconfigmode-draw}
\colorlet{advancedfit-draw}{gray-2}

% for basic use
\colorlet{basicuse-draw}{any-draw}
\colorlet{anybuttonbasicuse-fill}{onoff-draw}
\colorlet{basicuse-text}{anybutton-fill}
...
\colorlet{generalinfo-draw}{advancedfit-draw}
\colorlet{generalinfo-fill}{anybutton-fill}
\colorlet{andurilinfo-draw}{anyconfigmode-draw}
...
\colorlet{voltagebox-text}{onoff-draw!75!voltagebox-frame}
...
\colorlet{simpleUIconfig-draw}{anyconfigmode-draw}
\colorlet{inherited-text}{simpleUIconfig-draw}
...
\tikzset{
    ...
    advancedfit/.style={
        advancedconfig,
        draw=advancedfit-draw,
        fill=none,
        inner sep=\borderspace
    },
    advancedborder/.style={
        advancedfit,
        inner sep=0cm
    }
}
...
\node (Ramp Stepped 2-3)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!90,
    bottom color=rampstepped-topbottom!84
]
{};
...
\node (Ramp Stepped 3-4)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!84,
    bottom color=rampstepped-topbottom!78
]
{};
...
\node (Ramp Stepped 4-5)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!78,
    bottom color=rampstepped-topbottom!72
]
{};
...
\node (Ramp Stepped 5-6)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!72,
    bottom color=rampstepped-topbottom!66
]
{};
...
\node (Ramp Stepped 6-7)[
    ...
    anchor=south,
    top color=rampstepped-topbottom!66,
    bottom color=rampstepped-topbottom!60
]
{};
...
\draw (Ramp text Memory.south) edge[
    arrows={->},
    anyline ramp,
    shorten >=0.05cm,
    shorten <=0.05cm
...
{ [on background layer]
    \node (Strobe Modes fit)[
        advancedfit,
        draw=none, % Strobe Modes fit replaced with border
...
{3H} (Strobe Modes fit.47);

\draw (Strobe Modes fit.77) edge[
    ->,
    advancedline,
    out=80,
    in=180,
...
\draw (Batt Check from OFF.west) edge[
    ->,
    advancedline,
    out=180,
    in=30,
...
{ [on background layer]
    \node (Blinky Modes fit)[
        advancedfit,
        draw=none, % Blinky Modes fit replaced with border
        yshift=0.2pt, % 1/2 line thickness for outer alignment
...
\node (Tactical Mode Config)[
    advancedtable,
    right=0.9cm of Blinky Modes fit.south east,
    anchor=south west
]
{
    \spacingnoextra
...
\draw (Tactical Mode from OFF right.south) edge[
    ->,
    advancedline,
    out=270,
    in=90,
...
]
{
    ...
    \normalsize Diagram Release Dark-04\\[4pt]
    Diagram Repository:\\
