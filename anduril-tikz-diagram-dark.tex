% Diagram for the Anduril 2 UI, dark mode edition
% Copyright (C) 2025-2026 Guido dirtydancing
...
% for defining colors
\definecolor{green-2}{HTML}{00FF6B}
\definecolor{black-2}{HTML}{12161A}
\definecolor{blue-2}{HTML}{3090F3}
\definecolor{darkblue-2}{HTML}{3C5F88}
\definecolor{yellow-2}{HTML}{F3EA6D}
\definecolor{gray-2}{HTML}{4A535D}
\definecolor{orange-2}{HTML}{FF994E}

% any = for Simple UI and Advanced UI
\colorlet{any-draw}{green-2}
\colorlet{anyconfig-draw}{any-draw}
\colorlet{anyconfig-fill}{black-2}
\colorlet{any-text}{any-draw}
\colorlet{anybutton-draw}{anyconfig-draw}
\colorlet{anybutton-fill}{anyconfig-fill}
\colorlet{anybutton-text}{any-text}

% advanced = for Advanced UI only
\colorlet{advanced-draw}{blue-2}
\colorlet{advancedconfig-draw}{advanced-draw}
\colorlet{advancedconfig-fill}{anyconfig-fill}
\colorlet{advanced-text}{advanced-draw}
\colorlet{advancedbutton-fill}{anybutton-fill}
\colorlet{advancedbutton-text}{advanced-text}
\colorlet{advancedUI-draw}{advanced-draw}

% for Advanced UI - config menus
\colorlet{advancedconfigmenu-draw}{darkblue-2}
\colorlet{advancedconfigmenu-fill}{advancedconfig-fill}
\colorlet{advancedconfigmenu-text}{advanced-text}

% for Advanced UI - Simple UI config menu
\colorlet{simpleUIconfigmenu-draw}{yellow-2}
\colorlet{inherited-text}{simpleUIconfigmenu-draw}

% simple = for Simple UI only
\colorlet{simple-draw}{any-draw}
\colorlet{simplebutton-double}{anybutton-fill}
\colorlet{simpleUI-draw}{any-draw}
\colorlet{simple-text}{any-text}

% for UI switch lines
\colorlet{advancedUIswitchline-draw}{simpleUIconfigmenu-draw}
\colorlet{simpleUIswitchline-draw}{advancedUIswitchline-draw}

% for Extended Simple UI
\colorlet{extendedsimpleUI-draw}{any-draw}
\colorlet{extendedsimpleUI-fill}{anybutton-fill}

% for On, Ramp, Off, and Lockout
\colorlet{onoff-draw}{white}
\colorlet{onoffbutton-fill}{anybutton-fill}
\colorlet{onoff-text}{onoff-draw}
\colorlet{onofframplabel-draw}{any-draw}
\colorlet{onofframplabel-fill}{onoffbutton-fill}
\colorlet{onofframplabel-text}{any-text}
\colorlet{onofftogglerampstyle-draw}{advanced-draw}
\colorlet{onofftogglerampstyle-fill}{onoffbutton-fill}
\colorlet{onofftogglerampstyle-text}{advanced-text}

% any... mode = for Batt Check from OFF
\colorlet{anyconfigmode-draw}{simpleUIconfigmenu-draw}

% advanced... mode = for strobe modes and blinky modes
\colorlet{advancedconfigmode-draw}{anyconfigmode-draw}
\colorlet{advancedbordermode-draw}{gray-2}

% for basic use
\colorlet{basicuse-draw}{orange-2}
\colorlet{anybuttonbasicuse-draw}{basicuse-draw}
\colorlet{anybuttonbasicuse-fill}{anybutton-fill}
\colorlet{basicuse-text}{any-text}
\colorlet{buttonpressesbasicuse-draw}{basicuse-draw}
\colorlet{fillarrowbasicuse}{anybutton-fill}

% for ramp image
\colorlet{rampsmooth-topbottom}{anybutton-fill}
\colorlet{rampstepped-topbottom}{rampsmooth-topbottom}
\colorlet{rampcombinedinside1-draw}{rampsmooth-topbottom}
...
% for Factory Reset
\colorlet{factoryreset-draw}{advancedUIswitchline-draw}
\colorlet{factoryreset-fill}{anyconfig-fill}

% for line from Factory Reset to Simple UI
\colorlet{factoryresetsimpleUI-draw}{factoryreset-draw}

% for general information
\colorlet{generalinfo-draw}{advancedbordermode-draw}
\colorlet{generalinfo-fill}{anybutton-fill}
\colorlet{andurilinfo-draw}{simpleUIconfigmenu-draw}
\colorlet{andurilinfo-fill}{generalinfo-fill}
\colorlet{andurilinfo-text}{andurilinfo-draw}
\colorlet{voltagecolorinfo-fill}{generalinfo-fill}
\colorlet{buttonpressesinfo-fill}{generalinfo-fill}
\colorlet{defaultsvaryinfo-fill}{generalinfo-fill}
\colorlet{matrixlegendinfo-fill}{generalinfo-fill}

% for voltage colors
\colorlet{voltagebox-frame}{anyconfig-fill}
\colorlet{voltagebox-back}{voltagebox-frame}
\colorlet{voltagebox-mixfill}{voltagebox-frame}
\colorlet{voltageboxcolor-red}{red!25!voltagebox-mixfill}
\colorlet{voltageboxcolor-yellow}{yellow!25!voltagebox-mixfill}
\colorlet{voltageboxcolor-green}{green!25!voltagebox-mixfill}
\colorlet{voltageboxcolor-cyan}{cyan!25!voltagebox-mixfill}
\colorlet{voltageboxcolor-blue}{blue!25!voltagebox-mixfill}
\colorlet{voltageboxcolor-purple}{purple!25!voltagebox-mixfill}
\colorlet{voltagebox-text}{any-draw!50}
\colorlet{voltageboxadv-text}{advanced-draw!50}

% for tint ramp colors
\colorlet{tintrampbox-frame}{voltagebox-frame}
\colorlet{tintrampbox-mixfill}{voltagebox-mixfill}
\colorlet{tintrampboxcolor-left}{magenta!20!tintrampbox-mixfill}
\colorlet{tintrampboxcolor-right}{orange!20!tintrampbox-mixfill}
\colorlet{tintrampbox-text}{voltagebox-text}
\colorlet{tintrampboxadv-text}{voltageboxadv-text}

% for infotext
\colorlet{infoany-text}{any-text}
\colorlet{infoadvanced-text}{advanced-text}
\colorlet{infoadvancedconfigmenu-text}{advancedconfigmenu-text}
\colorlet{infosimple-text}{simple-text}

% for setting the page background color
\pagecolor{anyconfig-fill} % default: transparent background

% Preamble - 03 tikz ---------------------------------------------------
% ----------------------------------------------------------------------
\usepackage{tikz} % for creating graphics
% tikz package is also loaded by tcolorbox package
...
\usetikzlibrary{tikzmark} % for marking a point for further use
...
\tikzset{
    ...
    anyconfig/.style={
        ...
        text=any-text,
        inner sep=0.1cm,
        rounded corners=4.5pt, % default: 4pt
        align=left
    },
    anybutton/.style={
        draw=anybutton-draw,
...
% for Advanced UI - config menus
\tikzset{
    advancedconfigmenu/.style={
        advancedconfig,
        draw=advancedconfigmenu-draw,
        fill=advancedconfigmenu-fill,
        text=advancedconfigmenu-text
    }
}

% for Advanced UI - Simple UI config menu
\tikzset{
    simpleUIconfigmenu/.style={
        advancedconfigmenu,
        draw=simpleUIconfigmenu-draw
    }
}
...
% for UI switch lines
\tikzset{
    advancedUI switch line/.style={
        simpleline,
        draw=advancedUIswitchline-draw,
        very thick
    },
    simpleUI switch line/.style={
        advancedline,
        draw=simpleUIswitchline-draw,
        very thick
    }
}
...
\tikzset{
    ...
    on-extra ramp label/.style={
        on-extra,
        draw=onofframplabel-draw,
        fill=onofframplabel-fill,
        text=onofframplabel-text,
        inner xsep=0.35cm
    },
    on-extra toggle ramp style/.style={
        on-extra,
        draw=onofftogglerampstyle-draw,
        fill=onofftogglerampstyle-fill,
        text=onofftogglerampstyle-text
    },
    onoff/.style={
        on-extra,
        font=\bfseries\Huge,
...
% for Lockout to Off right arrows
\tikzset{
    lockoutoffright-arrow/.style={
        draw=none,
        fill=none,
        inner sep=0cm,
...
\tikzset{
    ...
    anybutton basic use/.style={
        anybutton,
        draw=anybuttonbasicuse-draw,
        line width=2pt,
        fill=anybuttonbasicuse-fill,
        text=basicuse-text,
        font=\bfseries
    },
    button presses basic use fit/.style={
        advancedborder-mode,
        draw=buttonpressesbasicuse-draw,
        thick,
        inner xsep=0.03cm,
        inner ysep=0.05cm,
...
\tikzset{
    rampstepped/.style={
        ...
        draw=none,
        inner sep=0cm,
        outer xsep=-0.02pt, % -0.02pt for a cleaner look
        outer ysep=-0.1pt, % -0.1pt for a cleaner look
        minimum width=0.66cm+0.3pt,
        minimum height=0.9cm+0.1pt+0.2pt % +0.2pt for a cleaner look
    },
    rampsmooth/.style={
        rampstepped,
        minimum width=0.66cm+0.3pt,
        minimum height=5.4cm+0.6pt+0.2pt % +0.2pt for a cleaner look
        % 5.4cm = 6 x 0.9cm
    },
    rampcombined/.style={
        rectangle,
...
% for Factory Reset
\tikzset{
    anyconfig factoryreset/.style={
        anyconfig,
        draw=factoryreset-draw,
        fill=factoryreset-fill
    }
}

% for line from Factory Reset to Simple UI
\tikzset{
    anyline factoryreset simpleUI/.style={
        anyline,
        draw=factoryresetsimpleUI-draw,
...
\tikzset{
    ...
    andurilinfo/.style={
        ...
        very thick,
        fill=andurilinfo-fill,
        text=andurilinfo-text
    },
    voltagecolorinfo/.style={
        generalinfo,
        fill=voltagecolorinfo-fill
    },
    buttonpressesinfo/.style={
        generalinfo,
        fill=buttonpressesinfo-fill
    },
    defaultsvaryinfo/.style={
        generalinfo,
        fill=defaultsvaryinfo-fill
    },
    matrixlegendinfo/.style={
        generalinfo,
        fill=matrixlegendinfo-fill,
        matrix of nodes,
...
\tikzset{
    ...
    anybutton basic use legend/.style={
        anybutton basic use,
        fill=matrixlegendinfo-fill
    },
    ...
    simplebutton legend/.style={
        simplebutton,
        fill=matrixlegendinfo-fill,
        double=matrixlegendinfo-fill
    },
    advancedline legend/.style={
        advancedline,
        line cap=round
    },
    advancedbutton legend/.style={
        advancedbutton,
        fill=matrixlegendinfo-fill
    },
...
\NewTblrEnviron{tblr-advancedconfigmenu} % for config menus
\SetTblrInner[tblr-advancedconfigmenu]{
    row{1}     = {abovesep=0.5pt}, % default: 2pt
    row{2-Y}   = {rowsep=0.5pt}, % default: 2pt
    row{Z}     = {abovesep=0.5pt, belowsep=0pt}, % default: 2pt
...
\NewTblrEnviron{tblr-buttonpresses} % for button presses
\SetTblrInner[tblr-buttonpresses]{
    row{1}     = {abovesep=0.5pt},
    row{2-Y}   = {rowsep=0pt},
    row{3}     = {belowsep=0.9pt}, % for basic use fit
    row{Z}     = {abovesep=2pt, belowsep=0pt},
    colsep     = 0pt,
    column{3}  = {leftsep=2.25pt}, % for horizontal space to colon
    cell{1}{1} = {c=3}{font=\bfseries\normalsize},
    cell{Z}{1} = {c=3}{},
    cells      = l
}
...
\tcbuselibrary{skins} % for additional styles (skins)

% for setting options for every following tcolorbox
\tcbset{
    colframe=voltagebox-frame, % initially black!75!white
    opacityframe=0, % initially 1.0
    boxrule=0cm, % initially 0.05cm
    colback=voltagebox-back, % initially black!5!white
    coltext=voltagebox-text, % initially black
    left=0cm, % initially 0.4cm
    right=0cm, % initially 0.4cm
    top=0.005cm, % initially 0.2cm
    bottom=0.005cm, % initially 0.2cm
    boxsep=0cm, % initially 0.1cm
    arc=0.05cm, % initially 0.1cm
    sharp corners, % initially all rounded corners
...
\newtcbox{\voltageboxpurple}{
    colback=voltageboxcolor-purple,
    right=0.02cm,
    rounded corners=east
}

% for the left part of voltage: red
% adv = Advanced UI function
\newtcbox{\voltageboxredadv}{
    colback=voltageboxcolor-red,
    coltext=voltageboxadv-text,
    left=0.02cm,
    rounded corners=west
}
...
\newcommand{\textboxauxledcfv}{%
    \voltageboxred{R-2.9,%
        \vphantom{Voltage,Ú}}%
    \voltagebox[voltageboxcolor-yellow]{\hspace{0.013cm}Y-3.3,%
        \vphantom{Voltage,Ú}}%
    \voltagebox[voltageboxcolor-green]{\hspace{0.013cm}G-3.5,%
        \vphantom{Voltage,Ú}}%
    \voltagebox[voltageboxcolor-cyan]{\hspace{0.013cm}C-3.7,%
        \vphantom{Voltage,Ú}}%
    \voltagebox[voltageboxcolor-blue]{\hspace{0.013cm}B-3.9,%
        \vphantom{Voltage,Ú}}%
...
% and for post-off voltage display
\newcommand{\textboxvoltage}{%
    \voltageboxredadv{V%
        \vphantom{Voltage}}%
    \voltageboxadv[voltageboxcolor-yellow]{o%
        \vphantom{Voltage}}%
    \voltageboxadv[voltageboxcolor-green]{lt%
        \vphantom{Voltage}}%
    \voltageboxadv[voltageboxcolor-cyan]{a%
        \vphantom{Voltage}}%
    \voltageboxadv[voltageboxcolor-blue]{g%
        \vphantom{Voltage}}%
    \voltageboxpurpleadv{e%
        \vphantom{Voltage}}%
}

% for tint ramp
\newtcbox{\tintrampbox}{
    colframe=tintrampbox-frame,
    skin=enhanced, % for interior style
    interior style={
        left color=tintrampboxcolor-left,
        right color=tintrampboxcolor-right
    },
    coltext=tintrampbox-text,
    left=0.02cm,
    right=0.02cm,
    rounded corners
}
...
% for infotext for Advanced UI - config menus
\newcommand{\infotextadvancedconfigmenu}[1]{\textcolor
    {infoadvancedconfigmenu-text}{#1}}

% for infotext for Simple UI only
\newcommand{\infotextsimple}[1]{\textcolor{infosimple-text}{#1}}

% for text for basic use
\newcommand{\textbasicuse}[1]{\textcolor{basicuse-text}{#1}}

% for text for inherited
\newcommand{\textinherited}[1]{\textcolor{inherited-text}{#1}}
...
% for the next aux LED setting again
% (Unicode character North East Arrow)
\newcommand{\nextauxagain}{\char"2197}
...
at (current page.center)[
    rampsmooth,
    anchor=east,
    top color=rampsmooth-topbottom!60,
    bottom color=rampsmooth-topbottom!90
]
{};

% Stepped Ramp (number of steps: 7)
\node (Ramp Stepped 1-2)[
    alias=stepped-step,
    rampstepped,
    right=0cm of Ramp Smooth.south east,
    anchor=south west,
    top color=rampstepped-topbottom!96,
    bottom color=rampstepped-topbottom!90
]
{};

\foreach \x/\y/\z[
    evaluate=\y as \ytop using \y*6,
    evaluate=\z as \zbottom using \z*6
]
in {2-3/15/14, 3-4/14/13, 4-5/13/12, 5-6/12/11, 6-7/11/10}
\node (Ramp Stepped \x)[
    alias=stepped-step,
    rampstepped,
    above=0cm of stepped-step,
    anchor=south,
    top color=rampstepped-topbottom!\ytop,
    bottom color=rampstepped-topbottom!\zbottom
]
{};

% Further ramp elements
\node (Ramp inside 1)
at (current page.center)[
...
at (Ramp.south)[
    ramptextconfig,
    above=0.05cm+3.2pt % +3.2pt for Ramp inside 1
]
...
\path (ON Ramp.north) edge[
    arrows={<[open, fill=fillarrowbasicuse]->},
    anyline basic use,
    shorten <=0.15cm, % out
    shorten >=0.05cm % in
]
node[
    anybutton basic use,
    pos=0.53,
    label={ [align=left, xshift=0.515cm] right:
        \infotextany{Ramp up}\\
...
node[
    anybutton,
    pos=0.43,
    label={ [align=left, xshift=0.515cm+1.4pt] right:
    % +1.4pt for vertical alignment
...
{ [on background layer]
    \node (Turbo)[
        turbocombined,
        below=0.01pt of Ramp.north, % 0.01pt for a cleaner look
        anchor=south
    ]
    {};
}
...
\path (OFF.north) edge[
    ...
    shorten >=0.2pt, % in
    % 0.2pt: 0.5 line thickness (turbocombined)
    out=90,
    in=180,
    looseness=1.4
]
...
{ [on above layer]
    \path (OFF.north) edge[
        ...
        anyline,
        shorten >=0.2pt, % in
        % 0.2pt: 0.5 line thickness (rampcombined)
        out=90,
        in=180,
        looseness=1.3
    ]
...
node[
    ...
    label={ [align=left] right:
        ...
        \infotextadvanced{(Andúril 2 style)}
    }
]
{2C} (Turbo.north east);
...
% Momentary Turbo 3H from ON, ramp image
{ [on above layer]
    \draw (Ramp.west) edge[
        {Round Cap[sep=3.35cm]}-{Round Cap[sep=1.3cm]},
        advancedline,
        advancedbutton-fill,
        line width=2.4pt,
        shorten <=2pt, % out
...
{5C} (Momentary Mode from OFF ON.1);
...
{5C} (Momentary Mode from OFF ON.179);
...
% +0.2pt: 0.5 line thickness for outer alignment
...
{ [on background layer]
    ...
    {5C}(Momentary Mode from OFF ON.190);
}
...
\node (Batt Check from OFF)[
    anyconfig-mode,
    above left=1.62cm and 0.51cm of
...
{ [on above layer]
    \path (OFF.south) edge[
        {Round Cap[sep=4.3cm]}-{Round Cap[sep=2.3cm]},
        anyline,
        anybutton-fill,
        line width=2.4pt,
        out=270,
...
{ [on background layer]
    \node (Voltage Config from Batt Check)[
        advancedconfigmenu,
        right=1.8cm of Strobe Modes Actions.south east,
        anchor=south west
    ]
    {
        \spacingnoextra
        \begin{tblr-advancedconfigmenu}{}
            ...
            1 & Voltage Correction Factor\\
              & {\char"00B1{}0.30V, 0.05V steps\\
                 ...
                 7C = 0V (default)\\
                 13C = +0.30V}\\
            2 & {Post-Off \textboxvoltage{} Display\\
...
{7H} (Voltage Config from Batt Check.324);
...
{7H} (Temp Check Thermal Config.186);
...
\path (Temp Check from Batt Check.220) edge[
    ->,
    advancedline-mode,
    out=270,
    in=90,
...
{ [on background layer]
    ...
    {
        \firstline{\tintrampbox{Tint Ramp}}
...
{ [on background layer]
    ...
    ]
    {
        \spacingnoextra
        \begin{tblr-advancedconfigmenu}{
            row{2,6}     = {abovesep=3pt, belowsep=2pt},
            cell{2,6}{1} = {c=2}{}
        }
            Ramp Config &\\
            Smooth Ramp &\\
...
{ [on background layer]
    \node (Channel Mode Config from ON)[
        advancedconfigmenu,
        above=0.75cm of Next Channel Mode from ON.north west,
        anchor=south west
    ]
    {
        \spacingnoextra
    ...
    ]
    {
        ...
        \begin{tblr-advancedconfigmenu}{}
            ...
            2 & Manual memory timer\inherited{}\\
              & {0C = Disable\\
                 nC = n minutes}\\
            3 & {Ramp-after-moon style\inherited{}\\
                 (1H from Off)}\\
            ...
            4 & {Advanced UI's turbo style\\
              ...
              & {0C = Ceiling only, no turbo\\
                 \char"2192{} momentary ceiling only\\
                 1C = Turbo\\
                 (Andúril 1 style)\\
...
{10H} (Ramp Extras Config from ON.275);

% Types of brightness memory information
\node (Types of brightness memory information)[
    advancedconfig,
...
]
{
    ...
    Manual: user's saved\\
    Hybrid: automatic first,\\
    manual after n minutes\vphantom{y}
};

% Manual Memory from ON
\node (Manual Memory from ON)[
    advancedconfig,
    below=0.2cm of Types of brightness memory information.south west,
    anchor=north west
]
{
...
{10C} (Manual Memory from ON.south);
...
{10H} (Simple UI Config from OFF.278);
...
{ [on background layer]
    ...
    ]
    {
        ...
        \begin{tblr-advancedconfigmenu}{
            ...
            Hardware-specific &\\
            1 & \tintrampboxadv{Tint Ramp} style\\
              & {0C = Smooth ramp\\
                 1C = Middle tint only\\
                 2C = Channel toggle\\
                 3+C = Stepped ramp\\
...
{ [on background layer]
    \node (Tactical Mode Config)[
        advancedconfigmenu,
        right=1.2cm of Blinky Modes border south-east,
        anchor=south west
    ]
    {
        \spacingnoextra
...
\node (Version Check from OFF right)[
    anyconfig,
    above=1.5cm of Factory Reset from OFF right.north east,
    anchor=south east
]
{
...
% Line from Factory Reset to Simple UI

% -0.2pt: 0.5 line thickness for vertical alignment
\coordinate (Factory Reset right) at
    ($(Factory Reset from OFF right.east) + (0.45cm-0.2pt, 0cm)$);
\coordinate (Simple UI switch right) at
    ($(Simple UI switch from OFF right.east) + (0.45cm-0.2pt, 0cm)$);

{ [on background layer]
    \path[
        ->,
        anyline factoryreset simpleUI
    ]
    (Factory Reset from OFF right.east)
    -- (Factory Reset right)
    -- (Simple UI switch right)
    -- (Simple UI switch from OFF right.east);
}
...
]
{
    ...
    \normalsize Diagram Release Dark-10\\[4pt]
    Diagram Repository:\\
    https://github.com/dirtydancing/\\
    anduril-tikz-diagram-dark
    \spacingv
...
{
    \spacingnoextra
    \begin{tblr-buttonpresses}{}
        Button Presses\vphantom{Config} & &\\
        \tikzmarknode{buttonpresses-1C}
            {\textbasicuse{1C}} &
            \textbasicuse{:} &
        \tikzmarknode{buttonpresses-Click}
            {\textbasicuse{Click\hspace{0.015cm}}}\\
        \tikzmarknode{buttonpresses-1H}
            {\textbasicuse{1H}} &
            \textbasicuse{:} &
        \tikzmarknode{buttonpresses-Hold}
            {\textbasicuse{Hold}}\\
        2C & : & Click, Click\\
        2H & : & Click, Hold\\
        3C & : & Click, Click, Click\\
        3H & : & Click, Click, Hold\\
        {\infotextadvancedconfigmenu{In a config menu, release}\\
         \infotextadvancedconfigmenu{button after the desired}\\
         \infotextadvancedconfigmenu{number of blinks; when}\\
         \infotextadvancedconfigmenu{entering a value, 1H = 10C}} & &\\
    \end{tblr-buttonpresses}
};

\node (Button Presses basic use fit)[
    button presses basic use fit,
    fit=(buttonpresses-1C)
    (buttonpresses-Click)
    (buttonpresses-1H)
    (buttonpresses-Hold)
]
...
% Defaults vary by light
\node (Defaults vary by light)[
    defaultsvaryinfo,
    below=0.1cm of Button Presses.south west,
    anchor=north west
]
{Defaults vary by light.};
...
{
    & \textbasicuse{All the user needs to know
      for basic use\vphantom{y}}\\
    ...
    \textinherited{Inherited by Simple UI}\\
};

\path (Legend-1-1.west) edge[
    -,
    anyline basic use legend,
    shorten <=0.25pt, % out (0.4pt overhang)
    shorten >=0.25pt, % in (0.4pt overhang)
    out=0,
    in=180
]
node[
    anybutton basic use legend,
    pos=0.5
]
...
} % for ending on background layer
